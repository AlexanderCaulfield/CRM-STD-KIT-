...
<body>
	...
	<div id="content">
		<div class = "container-fluid">
			...
			<?php
				$listUniversitety = getAllUniversitety($db);
			?>
			<table class = "custom-table">
				<tr>
					<th style="width: 5%">Номер</th>
					<th style="width: 92%">Наименование</th>
					<th style="width: 3%">Удаление</th>
				</tr>

				<?php foreach ($listUniversitety as $listUniversitety) { ?>
					<tr>
						<td><?php echo $listUniversitety['id_Universitet']; ?></td>
						<td><a href="../Edit/editUniversitety.php?id_Universitet=<?php echo $listUniversitety['id_Universitet'];?>"><?php echo $listUniversitety['Imya_Universitet']; ?></a></td>
						<td><a id="deleteButton" class="btn btn-danger" href="../Delete/deleteUniversitety.php?id_Universitet=<?php echo $listUniversitety['id_Universitet'];?>">Удалить</a></td>
					</tr>
				<?php } ?>
			</table>

		<div class="buttons">	
			<button id="addButton" class="btn btn-default">Добавить университет</button>
		</div>

		<form action="" method="POST" role="form" style="display: none; margin-top: 20px;">

			<div class="form-group">
				<label for="">Введите наименование университета</label>
				<input type="text" class="form-control" id="imya" name="imya" placeholder="Наименование университета">
			</div>
