...
<body>
	...
	<div id="content">
		<div class = "container-fluid">
			...
			<?php
				$listTipyZadach = getAllTipyZadach($db);
			?>
			<table class = "custom-table">
				<tr>
					<th style="width: 5%">Номер</th>
					<th style="width: 92%">Наименование типа</th>
					<th style="width: 3%">Удаление</th>
				</tr>

				<?php foreach ($listTipyZadach as $listTipyZadach) { ?>
					<tr>
						<td><?php echo $listTipyZadach['id_TipZadach']; ?></td>
						<td><a href="../Edit/editTipyZadach.php?id_TipZadach=<?php echo $listTipyZadach['id_TipZadach'];?>"><?php echo $listTipyZadach['Imya_TipZadach']; ?></a></td>
						<td><a id="deleteButton" class="btn btn-danger" href="../Delete/deleteTipyZadach.php?id_TipZadach=<?php echo $listTipyZadach['id_TipZadach'];?>">Удалить</a></td>
					</tr>
				<?php } ?>
			</table>

		<div class="buttons">
			<button id="addButton" class="btn btn-default">Добавить тип задачи</button>
		</div>

		<form action="" method="POST" role="form" style="display: none; margin-top: 20px;">

			<div class="form-group">
				<label for="">Введите наименование типа задачи</label>
				<input type="text" class="form-control" id="imya" name="imya" placeholder="Наименование типа задачи">
			</div>
