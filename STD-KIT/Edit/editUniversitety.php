...
<body>
	...
	<div id="content">
		<div class = "container-fluid">
			...
			<?php
				$id = $_GET['id_Universitet'];
				if($id){
				$listUniversitety = getUniversitetById($db, $id);
				}else {
					echo "<h1>Error<h1>";
					exit();
				}
			?>
			<form action="../Save/saveUniversitety.php" method="post">
				<input type="hidden" name="id" value="<?php echo $listUniversitety['id_Universitet']; ?>">
                <div class="form-group">
					<label for="imya">Наименование университета</label>
					<input type="text" class="form-control" id="imya" name="imya" value="<?php echo $listUniversitety['Imya_Universitet']; ?>">
				</div>
