...
<body>
	...
	<div id="content">
		<div class = "container-fluid">
			...
			<?php
				$id = $_GET['id_StatusZadach'];
				if($id){
				$listStatusyZadach = getStatusZadachById($db, $id);
				}else {
					echo "<h1>Error<h1>";
					exit();
				}
			?>
			<form action="../Save/saveStatusyZadach.php" method="post">
				<input type="hidden" name="id" value="<?php echo $listStatusyZadach['id_StatusZadach']; ?>">
				<div class="form-group">
					<label for="imya">Наименование статуса задачи</label>
					<input type="text" class="form-control" id="imya" name="imya" value="<?php echo $listStatusyZadach['Imya_StatusZadach']; ?>">
				</div>
