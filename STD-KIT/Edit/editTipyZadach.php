	...
	<div id="content">
		<div class = "container-fluid">
			...
			<?php
				...
				if($id){
				$listTipyZadach = getTipZadachById($db, $id);
				}else {
					echo "<h1>Error<h1>";
					exit();
				}
			?>
			<form action="../Save/saveTipyZadach.php" method="post">
				<input type="hidden" name="id" value="<?php echo $listTipyZadach['id_TipZadach']; ?>">
				<div class="form-group">
					<label for="imya">Наименование типа задачи</label>
					<input type="text" class="form-control" id="imya" name="imya" value="<?php echo $listTipyZadach['Imya_TipZadach']; ?>">
				</div>
